  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        queryLimit: 1000,
        collectionTypes: [`banners`, `services`, `edTeches`, `ed-tech-submodules`, `article`, `blog-category`,],
        singleTypes: [`ed-tech-page`, `global-seo`, `services-page`, `home`, `blog-page`, `bitway-page`, `contact-page`],
      },
    },
    `gatsby-plugin-image`,
